...
const staffDatabase = [
    ...
    { 
        id: 'andda', category: 'host', image: 'Image/安怛.png', serviceType: 'midnight', name: '安怛',
        profileImage: 'Image/安怛_profile.png',
    ...
    { 
        ...
        profileImage: 'Image/賽安_profile.png',
    ...
    { 
        id: 'esmee', category: 'host', image: 'Image/斯咪.png', serviceType: 'midnight', name: '斯咪',
        profileImage: 'Image/斯咪_profile.png',
    ...
    { 
        id: 'longting', category: 'host', image: 'Image/龍霆.png', serviceType: 'midnight', name: '龍霆',
        profileImage: 'Image/龍霆_profile.png',
    ...
    { 
        id: 'maogao', category: 'host', image: 'Image/貓糕.png', serviceType: 'standard', name: '貓糕',
        profileImage: 'Image/貓糕_profile.png',
    ...
    { 
        id: 'saiyi', category: 'host', image: 'Image/賽伊.png', serviceType: 'midnight', name: '賽伊',
        profileImage: 'Image/賽伊_profile.png',
...
function renderProfile(id) {
    ...
    container.innerHTML = `
        <div class="profile-visual">
            ...
            <div class="profile-img-box"><img src="${staff.profileImage || staff.image}" alt="${staff.name}"></div>
